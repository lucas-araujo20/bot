...
# login
email = "email@exemplo.com"  # insira seu email aqui
senha = "senha123"  # insira sua senha
cargo = "estagio"  # insira o cargo desejado
...
navegador.find_element(
    'xpath', '/html/body/main/div[1]/section/div[1]/div[4]/a').click()

# filtrando pesquisa
navegador.find_element(
    'xpath', '//*[@id="facetRenovationDateRange"]/div[1]/a').click()
navegador.find_element(
    'xpath', '//*[@id="facetRenovationDateRange"]/div[2]/div/a[1]').click()
...
for link in links:
    navegador.get(link)
    navegador.find_element(
        'xpath', '//*[@id="VacancyHeader"]/div[3]/div[1]/a').click()
    sleep(10)
